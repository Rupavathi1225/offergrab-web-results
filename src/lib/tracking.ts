...
export const trackClick = async (
  clickType: 'related_search' | 'web_result' | 'prelanding_submit' | 'landing2_view' | 'landing2_click' | 'fallback_redirect' | 'thankyou_view' | 'sitelink' | 'wr201_sponsored' | 'consultation_view' | 'consultation_click',
  itemId?: string,
  itemName?: string,
  page?: string,
  lid?: number,
